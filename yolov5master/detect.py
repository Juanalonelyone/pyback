...
from yolov5master.models.common import DetectMultiBackend
from yolov5master.utils.dataloaders import IMG_FORMATS, VID_FORMATS, LoadImages, LoadScreenshots, LoadStreams
from yolov5master.utils.general import (LOGGER, Profile, check_file, check_img_size, check_imshow, check_requirements, colorstr, cv2,
                           increment_path, non_max_suppression, print_args, scale_boxes, strip_optimizer, xyxy2xywh)
from yolov5master.utils.plots import Annotator, colors, save_one_box
from yolov5master.utils.torch_utils import select_device, smart_inference_mode


@smart_inference_mode()
def run(
        weights=ROOT / 'yolov5s.pt',  # model path or triton URL
        source=ROOT / 'data/vedio',  # file/dir/URL/glob/screen/0(webcam)
...
class DetectAPI:
    def __init__(self, weights='D:/work/mini/pyback/yolov5master/yolov5s.pt',
